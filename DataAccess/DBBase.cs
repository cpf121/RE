...
namespace DataAccess
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static DataSet ExecuteDataSet(out int result, string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        public static DataSet ExecuteDataSet(out int result, DataSet ds, string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        public static DataTable ExecuteDataSet(out int result, DataTable dt, string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        public static int ExecuteDataSet(DataSet ds, string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            SqlConnection conn = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand();
            try
        ...
        {
            int result = 0;
            ExecuteDataSet(out result, ds, connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
            return result;
        }
        ...
        {
            int result = 0;
            ExecuteDataSet(out result, dt, connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
            return result;
        }
        ...
        {
            int cmdresult = Convert.ToInt32(ExecuteScalar(connectionString, CommandType.StoredProcedure, strSql, null));
            if (cmdresult == 0)
            {
                return false;
            }
        ...
        {
            int cmdresult = Convert.ToInt32(ExecuteScalar(connectionString, CommandType.StoredProcedure, strSql, cmdParms));
            if (cmdresult == 0)
            {
                return false;
            }
        ...
        {
            object resulto = ExecuteScalar(connectionString, CommandType.StoredProcedure, strSql, cmdParms);
